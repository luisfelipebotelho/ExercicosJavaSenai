	...
	public static void main(String[] args) {
		...
		while (Character.toLowerCase(opt) == 's') {
			...
			try {
				...
				sc.nextLine();
				System.out.print("Entre com a cor do veículo: ");
				carro.setCor(sc.nextLine());

				System.out.print("Entre com o tipo do veículo (hatch/sedan/caminhonete): ");
				carro.setTipo(sc.nextLine());

				System.out.print("Veiculo novo ou seminovo: ");
				carro.setEstadoConservacao(sc.nextLine());

				System.out.print("Entre com o tipo do cambio do veículo (m/a): ");
				carro.setCambio(sc.next().charAt(0));

				System.out.print("Entre com o tipo de combustivel (g/a): ");
				carro.setTipoCombustivel(sc.next().charAt(0));

				System.out.print("Entre com o valor do veículo: ");
